...
const NavBar = ({nav, setNav}) => {
  ...
  return (
    <div className='fixed w-full bg-purple-600 h-14'>
      <div className='flex h-full justify-between'>
        ...
        <div className=' flex items-center pl-4 font-hind'>
          <span className='cursor-pointer text-lg'>IVO MAYDANA</span>
        </div>
          <div className='hidden md:flex md:items-center '>
            <span className='px-2 font-hind cursor-pointer' onClick={routerPushA}>ABOUT ME</span>
            <span className='px-2 font-hind cursor-pointer'>SKILLS</span>
            <span className='px-2 font-hind cursor-pointer'>PROYECTS</span>
            <span className='px-2 font-hind cursor-pointer'>CONTACT ME</span>
          </div>
